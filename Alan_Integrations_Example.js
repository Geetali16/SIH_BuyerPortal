...
question('what is this', p =>  {
    p.play('This is Wastify powered by TEAM_11, an extremely advanced voice assistant that can help you purchase material online.');
});

question('What (all can you do for me|can you do?)', p => {
    p.play('I can order product materials for you and get them delivered to your location.');
});
